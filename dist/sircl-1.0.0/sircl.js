...
__rb.submitInline = function (event, triggerElement, formOrData, method, href, target, inlineTarget, inlineCached, hist) {
    if (inlineTarget) {
        if (inlineCached) {
        ...
        var data = (formOrData == null) ? "" : (formOrData.serialize) ? formOrData.serialize() : jQuery.param(formOrData);
